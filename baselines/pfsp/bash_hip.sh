...
gcc -O3 -Wall -g pfsp_gpu_hip.o lib/c_taillard.o lib/c_bound_simple.o lib/c_bound_johnson.o lib/PFSP_node.o lib/Auxiliary.o lib/evaluate.o lib/c_bounds_gpu.o lib/Pool.o -o pfsp_gpu_hip.out -lm -lcudart -L/usr/local/cuda-11.2/targets/x86_64-linux/lib/
